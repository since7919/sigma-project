    ...
    types.forEach(type => {
        ...
        if (nameEl) {
            if (name) {
                ...
                if (type === 'inter') nameEl.textContent = 'db_intersections.csv';
                else if (type === 'maps') nameEl.textContent = 'db_signal_maps.csv';
                else if (type === 'plans') nameEl.textContent = 'db_tod_plans.csv';
                else if (type === 'links') nameEl.textContent = 'db_coordlink.geojson';
                else if (type === 'poly') nameEl.textContent = 'db_poly.geojson';
                else if (type === 'yearbook') nameEl.textContent = 'db_yearbook.csv';
                else nameEl.textContent = `db_${type}.csv`;
                nameEl.style.color = "#666666";
