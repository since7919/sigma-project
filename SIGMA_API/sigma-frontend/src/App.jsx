          ...
          >
            ...
            >
              {mapSignalType === 'compass' ? (
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" title="신호등 모드"><rect x="7" y="2" width="10" height="20" rx="3"></rect><circle cx="12" cy="7" r="2"></circle><circle cx="12" cy="12" r="2"></circle><circle cx="12" cy="17" r="2"></circle></svg>
              ) : (
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" title="화살표 모드"><path d="M14 21V5" /><path d="M10 9l4-4 4 4" /><path d="M14 15v-2a4 4 0 0 0-4-4H5" /><path d="M9 5l-4 4 4 4" /></svg>
              )}
            </button>
            <div style={{ width: '1px', height: '18px', background: 'rgba(255,255,255,0.15)', alignSelf: 'center', margin: '0 4px' }}></div>
            <button 
