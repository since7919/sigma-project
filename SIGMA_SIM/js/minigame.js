...
function initMiniGameMaster(forceGameIndex = -1) {
    ...
    if (!container) {
        ...
        if (loadingOverlay && loadingOverlay.style.display !== 'none') {
            ...
            container.style.cssText = "background: rgba(0,0,0,0.5); padding: 15px; border-radius: 10px; border: 1px solid rgba(255,255,255,0.1); width: 760px; text-align: center; margin-top: 20px;";
            container.innerHTML = `
