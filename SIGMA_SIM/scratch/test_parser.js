            ...
            if (tMatch) {
                ...
                while (rA < baseR + 30 && rA < sheetData.length) {
                    ...
                    if (!isNaN(parsedNoL) && parsedNoL >= 1 && parsedNoL <= 16) {
                        ...
                        tpPlans[parsedNoL - 1] = { cycle: lastCycL, offset: offL, splitA: sAL, splitB: sBL };
                    }
                    ...
                    if (!isNaN(parsedNoR) && parsedNoR >= 1 && parsedNoR <= 16) {
                        ...
                        tpPlans[parsedNoR - 1] = { cycle: lastCycR, offset: offR, splitA: sAR, splitB: sBR };
                    }
                    rA += 2;
                }
...
for (let i=0; i<16; i++) {
    if (tpPlansDict[1] && tpPlansDict[1][i]) {
        console.log("Pattern " + (i+1) + ": " + tpPlansDict[1][i].cycle + " / " + tpPlansDict[1][i].offset);
    }
}
