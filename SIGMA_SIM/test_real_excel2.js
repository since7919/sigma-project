...
const filePath = './1826 æ»±πø™(0530).xlsx';
...
if (tpPlansDict[1]) {
    for(let i=11; i<16; i++) console.log('Pattern ' + (i+1) + ':', tpPlansDict[1][i]);
}
if (tpPlansDict[2]) {
    for(let i=0; i<4; i++) console.log('T2 Pattern ' + (i+1) + ':', tpPlansDict[2][i]);
}
